 ...
 * 
 */
@WebServiceClient(name = "AlunoWebService", targetNamespace = "http://ws.exemplo.fiap.com.br/", wsdlLocation = "http://l2901micro21:8080/Exemplo3WS/AlunoWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ALUNOWEBSERVICE_QNAME = new QName("http://ws.exemplo.fiap.com.br/", "AlunoWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://l2901micro21:8080/Exemplo3WS/AlunoWebService?wsdl");
    ...
    public AlunoWeb getAlunoWebPort() {
        return super.getPort(new QName("http://ws.exemplo.fiap.com.br/", "AlunoWebPort"), AlunoWeb.class);
    }
    ...
    public AlunoWeb getAlunoWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.exemplo.fiap.com.br/", "AlunoWebPort"), AlunoWeb.class, features);
    }
